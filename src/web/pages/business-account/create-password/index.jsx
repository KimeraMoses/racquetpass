  ...
  return (
    <div className='create-password-container'>
      <div className='header-row'>
        ...
        <h1 className='header-row-heading'>{t('businessAccountPasswordHeading')}</h1>
      </div>
				...
				<form className='create-password-form'>
					<div>
						<div className='input-container'>
							<label className='input-label'>
								...
								<a className='link'>{t('businessAccountPasswordPlaceHolderHide')}</a>
							</label>
							<input className='form-input' type="text" placeholder={t('businessAccountPasswordPlaceHolder')} />
							<div className='password-strength'>
								<p className='password-strength-weak'>{t('businessAccountPasswordWeak')}</p>
							</div>
						</div>
						...
						<div className='password-recommendations'>
							<div className='password-recommendations-title'>{t('businessAccountPasswordRecommendation')}</div>
							<div className='password-recommendations-row'>
								<div className='icon'><img alt="Tick" src="/svg/blacktick.svg"/></div>
					...
					<div className='btn-container'>
						<CustomButton disabled size='lg' btn='primary'>
							<a href='/BusinessAccount/VerifyBusiness'>{t('businessAccountPasswordCreateBtn')}</a>
						</CustomButton>
					</div>
				</form>
			</div>
