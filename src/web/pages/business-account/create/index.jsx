    ...
    <div className="create-account-container">
      <div className="header-row">
        ...
        <h1 className="header-row-heading">
          {t('createBusinessAccountHeading')}
        </h1>
        <CustomButton size="sm" btn="white">
          <a href="/BusinessAccount">{t('accountSignIn')}</a>
        </CustomButton>
      </div>
      <div className="create-account-description">
        {t('createBusinessAccountDescription')}
      </div>
      <div className="create-account-body">
        <form className="business-account-form">
          <div className="input-container">
            <label className="input-label">
              {t('createBusinessAccountShopLabel')}
            </label>
            <input
              className="form-input"
              type="text"
              placeholder={t('createBusinessAccountShopPlaceholder')}
            />
          </div>
          <div className="input-container">
            <label className="input-label">
              {t('createBusinessAccountEmailLabel')}
            </label>
            <input
              className="form-input"
              type="email"
              placeholder={t('createBusinessAccountEmailPlaceholder')}
            />
          </div>
          <div className="input-container">
            <label className="input-label">
              {t('createBusinessAccountPhoneLabel')}
            </label>
            <input
              className="form-input"
              type="number"
              placeholder={t('createBusinessAccountPhonePlaceholder')}
            />
          </div>
          ...
          <div className="btn-container">
            <CustomButton size="lg" btn="primary">
              <a href="/BusinessAccount/VerifyPhone">
                {t('createBusinessAccountContinueBtn')}
              </a>
            </CustomButton>
          </div>
        </form>
