  ...
  return (
    <div className='order-submitted-detail-container'>
      <div>
						...
						<div className="state-half uncompleted">			
							<div className='icon'>
								<svg xmlns="http://www.w3.org/2000/svg" width="20" height="22" viewBox="0 0 20 22" fill="none">
									...
									<path d="M1.5 8.08984H18.5" stroke="#4A4A4A" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
									...
									<path d="M13.6947 12.6992H13.7037" stroke="#4A4A4A" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
									<path d="M13.6947 15.6992H13.7037" stroke="#4A4A4A" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
									<path d="M9.99548 12.6992H10.0045" stroke="#4A4A4A" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
									<path d="M9.99548 15.6992H10.0045" stroke="#4A4A4A" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
									<path d="M6.29431 12.6992H6.30329" stroke="#4A4A4A" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
									<path d="M6.29431 15.6992H6.30329" stroke="#4A4A4A" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
								</svg>
							</div>
        ...
        <div className='pickup'>{t('OrderSubmittedInfo')} <b>{t('OrderSubmittedInfoProgress')} </b> {t('OrderSubmittedInfoConfirmation')}</div>
      ...
      <div>
        <CustomButton size="lg" btn="primary"><a href="/CreateOrder/Locker">{t('OrderSubmittedBack')}</a></CustomButton>
      </div>
    </div>
  );
}
