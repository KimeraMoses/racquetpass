    ...
    <div className="scanned-order-container">
      <div>
        ...
        <div className="scanned-card">
          ...
          <div className="racquet-details">
            ...
            <div className="racquet-label">
              {t('orderScannedStringHeading')}
            </div>
      ...
      <div className="btn-container">
        <CustomButton size="lg" btn="primary">
          <a href="/CreateOrder/Details">{t('orderScannedComplete')}</a>
        </CustomButton>
      </div>
    </div>
  );
